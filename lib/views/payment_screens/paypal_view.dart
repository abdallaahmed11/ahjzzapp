...
class PayPalView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final Color paypalBlue = Color(0xFF003087);
    ...
    return ChangeNotifierProvider(
      ...
      child: Consumer<AlternativePaymentViewModel>(
        builder: (context, viewModel, child) {
          return Scaffold(
            appBar: AppBar(
              title: Text("PayPal Payment", style: TextStyle(color: Colors.white)),
            ...
            body: Padding(
              ...
              child: Column(
                ...
                children: [
                  Icon(Icons.paypal, size: 80, color: paypalBlue),
                  SizedBox(height: 20),
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      prefixIcon: Icon(Icons.email, color: paypalBlue),
                      border: OutlineInputBorder(),
                      focusedBorder: OutlineInputBorder(borderSide: BorderSide(color: paypalBlue, width: 2)),
                    ),
                  ),
                  ...
                  ElevatedButton(
                    ...
                    child: viewModel.isLoading
                        ...
                        : Text("Pay with PayPal", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                  ),
                ],
              ),
            ),
